...
nb10.cells = [
    md(
        ...
        "Runs the five end-to-end candidates on the benchmark sample and renders the\n"
        "comparison report:\n\n"
        "| Variant | Description |\n"
        "|---|---|\n"
        ...
        "| `sentence_level` | reviews split into sentences; the clustered unit is the *mention* — cluster sizes count mentions and distinct reviews |\n\n"
    ...
    code(
        "# Side-by-side 2-D scatter of the runs (sentence_level points are mentions)\n"
